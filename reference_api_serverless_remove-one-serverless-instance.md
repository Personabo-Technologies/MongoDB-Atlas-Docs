...
# Remove One Serverless Instance
...
Base URL: `https://cloud.mongodb.com/api/atlas/v1.0`
    ...
    DELETE /groups/{groupId}/serverless/{instanceName}  
...
## Example Request
    ...
    curl --user '{PUBLIC-KEY}:{PRIVATE-KEY}' --digest \  
         ...
         --include \  
         --request DELETE 'https://cloud.mongodb.com/api/atlas/v1.0/groups/{groupId}/serverless/{instanceName}?pretty=true'  
