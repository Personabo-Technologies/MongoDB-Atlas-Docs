...
## Resource
    ...
    POST /groups/{GROUP-ID}/maintenanceWindow/defer  
...
Unique identifier of the project for which you want to defer maintenance by
one week.
...
## Example Request
    ...
    curl --user "{PUBLIC-KEY}:{PRIVATE-KEY}" --digest \  
         ...
         --include \  
         --request POST "https://cloud.mongodb.com/api/atlas/v1.0/groups/{GROUP-ID}/maintenanceWindow/defer"  
